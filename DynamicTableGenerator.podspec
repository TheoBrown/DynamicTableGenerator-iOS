#
#  Be sure to run `pod spec lint DynamicTableGenerator.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files  = "DynamicTableGenerator", "DynamicTableGenerator/**/*.{h,m}"
  s.exclude_files = "DynamicTableGenerator/Exclude"
